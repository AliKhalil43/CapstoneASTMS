...
while traci.simulation.getMinExpectedNumber() > 0:
        ...
        for i in range(0,len(vehicles)):
                ...
                ##----------MACHINE LEARNING CODES/FUNCTIONS----------##
                ...
                trafficlightduration = [80,5,5]
                trafficsignal = [
                        "GGGG","yyyy","rrrr"
                        ]
              
                tfl = "1138151997"
                traci.trafficlight.setPhaseDuration(tfl, trafficlightduration[randrange(3)])
                traci.trafficlight.setRedYellowGreenState(tfl, trafficsignal[randrange(3)])
